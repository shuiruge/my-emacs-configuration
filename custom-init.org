...
CAUTION: Because of a bug of capf, corfu cannot work well with nix-shell, by
  typing nix-shell in eshell. It will keep inserting tabs.
  Reference: https://github.com/minad/corfu/issues/61.
...
Basic key chords are below. Mode-specific key chords are defined in the mode.
