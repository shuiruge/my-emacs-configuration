...
#+begin_src emacs-lisp
  (use-package files
    :ensure nil
    :custom
    (backup-directory-alist '(("." . (expand-file-name (concat (my-config-dir) "backups")))))
...
#+begin_src emacs-lisp
  (defun find-config ()
    (interactive)
    (find-file (expand-file-name (concat (my-config-dir) "custom-init.org"))))
#+end_src
...
#+begin_src emacs-lisp
  (defun reload-config()
    (interactive)
    (load-file (expand-file-name (concat (my-config-dir) "init.el"))))
#+end_src
