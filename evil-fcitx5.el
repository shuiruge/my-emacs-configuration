; evil-fcitx5.el -- providing auto toggling on the top of fcitx-remote
; something about fcitx5-remote program:
; `$ fcitx5-remote' return 0 - no input focus
;                         1 - default IME(English)
;                         2 - user's IME
; `$ fcitx5-remote -c' will set IME to 1 - default IME
; `$ fcitx5-remote -o' will set IME to 2 - user's IME
...
; 2 is the return value of `$ fcitx5-remote' when you toggle on your IME
...
(defun get-current-IME ()
  (if (equal (shell-command-to-string "fcitx5-remote")
                         user-IME-ID)
          "user-IME"
        "default-IME"))
...
(add-hook 'evil-insert-state-exit-hook
                  'exit-insert-evil-fcitx5)

(defun entry-insert-evil-fcitx5 ()
